//	@file Version: 1.0
//	@file Name: mission_scoutHeli.sqf
...
_missionType = "Immobile Scout Helicopter";
#ifdef __A2NET__
...
_vehicleClass = ["CSJ_oh6","CSJ_OH6a","uns_oh58a","uns_oh58b","CSJ_AH1g","CSJ_UH1Gun","CSJ_GHornet"] call BIS_fnc_selectRandom;
